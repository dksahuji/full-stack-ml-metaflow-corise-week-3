...
class TaxiFarePrediction2(FlowSpec):
    ...
    def transform_features(self, df):
        ...
        df = df.astype({"payment_type": str, "airport_fee": str, "PULocationID": str, "DOLocationID": str})
    ...
    def start(self):
        ...
        self.df = self.df.filter(items=['trip_distance', 'hour', 'passenger_count', 'payment_type'])
        ...
        print(self.numerical_columns, self.categorical_columns)
...
#    @resources(gpu=1)
    ...
    def validate(self):
        ...
        self.scores = cross_val_score(self.model_pipeline, self.X, self.y, cv=5)
